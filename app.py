...
if __name__ == "__main__":
    ...
    alpha = float(sys.argv[1]) if len(sys.argv) > 1 else 0.05        # default value for alpha is 0.5
    l1_ratio = float(sys.argv[2]) if len(sys.argv) > 2 else 0.05      # default value for l1_ratio is 0.5
    ...
    remote_server_uri="https://dagshub.com/MahsaMesgaran/mlflowexperiments.mlflow"
